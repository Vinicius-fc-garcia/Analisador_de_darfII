...
const App: React.FC = () => {
  ...
  return (
    // Fundo ajustado para um gradiente Azul Vibrante (SaaS Style)
    <div className="min-h-screen bg-blue-950 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-800 via-blue-950 to-slate-950 font-sans text-gray-900 pb-20">
      
      {/* Header Transparente */}
      <header className="border-b border-blue-800/50 bg-blue-950/50 backdrop-blur-sm py-4 mb-8 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {/* Aviso de Limites (Azul Escuro) */}
          <div className="text-sm text-blue-200 bg-blue-900/50 border border-blue-700/50 px-3 py-1 rounded-full shadow-sm backdrop-blur-md">
             Limite gratuito: <span className="font-semibold text-white">15 DARFs / minuto</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          {/* O FileUploader é branco por dentro, criando contraste com o fundo azul */}
          <div className="bg-white rounded-lg shadow-xl shadow-blue-900/20 overflow-hidden">
